...
var SpecialCharactersCheck = /[^A-Z0-9\_]/gi;
...
var createConstants = function createConstants(_ref6) {
  ...
  return verbs.reduce(function (a, b) {
    ...
    var key = "".concat(SCOPE, "_").concat(VERB).replace(SpecialCharactersCheck, '_');
    var value = "@".concat(SCOPE, "/").concat(VERB);
    a[key] = value;

    if (invocationType === InvocationType.ASYNC) {
      a["".concat(key, "_REQUESTED")] = "".concat(value, "_REQUESTED");
      a["".concat(key, "_RECEIVED")] = "".concat(value, "_RECEIVED");
      a["".concat(key, "_FAILED")] = "".concat(value, "_FAILED");
      a["".concat(key, "_DONE")] = "".concat(value, "_DONE");
    }
